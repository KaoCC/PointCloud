...
static void applyTrans(const std::array<std::array<float, 4>, 4>& trans, Vertex& point) {
...
static unsigned int addCube (RTCScene scene_i, RTCDevice device, const std::array<std::array<float, 4>, 4>& trans)
{
